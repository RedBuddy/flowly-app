...
export const BudgetSummary = ({ totalAssigned, totalSpent, totalAvailable }: Props) => {
  const spentPercent = totalAssigned > 0 ? (totalSpent / totalAssigned) * 100 : 0;
      ...
      <div className="bg-card rounded-2xl overflow-hidden shadow-soft border border-border/50 hover:shadow-card transition-all duration-300">
        ...
        <div className="px-4 py-3 flex items-center gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-xl font-bold text-foreground">{formatCurrency(totalAssigned)}</p>
      ...
      <div className="bg-card rounded-2xl overflow-hidden shadow-soft border border-border/50 hover:shadow-card transition-all duration-300">
        ...
        <div className="px-4 py-3 flex items-center gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-xl font-bold text-orange-500">{formatCurrency(totalSpent)}</p>
            <div className="h-1.5 rounded-full bg-muted overflow-hidden mt-2">
      ...
      <div className="bg-card rounded-2xl overflow-hidden shadow-soft border border-border/50 hover:shadow-card transition-all duration-300">
        ...
        <div className="px-4 py-3 flex items-center gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-xl font-bold text-emerald-500">{formatCurrency(totalAvailable)}</p>
            <div className="h-1.5 rounded-full bg-muted overflow-hidden mt-2">
